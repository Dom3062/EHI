...
-- Triggers
EHI.Trigger:UnhookTrigger(100144) -- Does not work in reworked version
EHI.Trigger:UpdateTriggerParams(102876, { special_function = SF.Trigger, data = { 1028762, 1028761, 1 } }) -- Needs to be reworked -> 1st gas can
...
local triggers =
{
    [1028762] = { id = "GasAmount", class = "EHIGasTracker", show_progress_on_finish = true, remove_on_max_progress = true, hint = EHI.Hints.run_Gas }
}
if EHI:MissionTrackersAndWaypointEnabled() then
    triggers[102876].data[4] = 4
end
