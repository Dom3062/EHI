...
elseif level_id == "chew" then -- The Biker Heist Day 2
    triggers = {
        ...
        [100558] = { tiem = 5, random_time = 5, id = "BileReturn", icons = { Icon.Heli, Icon.Escape, Icon.LootDrop } }
    }
...
elseif level_id == "wwh" then -- Alaskan Deal
    triggers = {
        [100944] = { max = 4, id = "wwh_10", icons = { "C_Locke_H_AlsDeal_HeadlessSnow" }, class = TT.AchievementProgress, condition = show_achievement },
...
elseif level_id == "dinner" then -- Slaughterhouse
    triggers = {
        ...
        [100485] = { time = 30, id = "farm_4", icons = { "C_Classics_H_Slaughterhouse_Pyromaniacs" }, class = TT.Achievement, condition = show_achievement },
...
elseif level_id == "arena" then -- The Alesso Heist
    triggers = {
        [100241] = { time = 19, id = "HeliEscape", icons = { Icon.Heli, Icon.Escape, Icon.LootDrop } },
...
elseif level_id == "rat" then -- Cook Off
    ...
    triggers = {
        ...
        [102318] = { time = 60 + 60 + 30 + 15 + anim_delay, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop } },
        [102319] = { time = 60 + 60 + 60 + 30 + 15 + anim_delay, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop } },
        ...
        [101982] = { time = 589/30 + 3, id = "Van", icons = { "pd2_car", Icon.Escape, Icon.LootDrop }, special_function = SF.SetTimeOrCreateTracker },
...
elseif level_id == "alex_1" then -- Rats Day 1
    ...
    triggers = {
        ...
        [101970] = { time = (240 + 12) - 3, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop } },
        [100721] = { time = 1, id = "CookDelay", icons = { Icon.Methlab, Icon.Wait }, special_function = SF.CreateAnotherTrackerWithTracker, data = { fake_id = 1007211 } },
...
elseif level_id == "chas" then -- Dragon Heist
    ...
    if Network:is_client() then
        triggers[100602] = { time = 90 + 5, random_time = 20, id = "LoudEscape", icons = { Icon.Car, Icon.Escape, Icon.LootDrop }, special_function = SF.AddTrackerIfDoesNotExist }
        triggers[102453] = { time = 60 + 12.5, random_time = 20, id = "HeliArrivesWithDrill", icons = { Icon.Heli, "pd2_drill", "pd2_goto" }, special_function = SF.AddTrackerIfDoesNotExist }
    end
...
elseif level_id == "spa" then -- Brooklyn 10-10
    triggers = {
        ...
        [101989] = { time = 360, id = "spa_5", icons = { "C_Continental_H_Brooklyn_ARendezvous" }, class = TT.Achievement, condition = ovk_and_up and show_achievement },
...
elseif level_id == "sah" then -- Shacklethorne Auction
    triggers = {
        ...
        [101050] = { time = 120 + 24 + 5 + 3, id = "EscapeHeli", icons = { "heli", "pd2_escape", "pd2_lootdrop" }, special_function = SF.ExecuteIfElementIsEnabled }, -- West
        [101039] = { time = 120 + 24 + 5 + 3, id = "EscapeHeli", icons = { "heli", "pd2_escape", "pd2_lootdrop" }, special_function = SF.ExecuteIfElementIsEnabled } -- East
    }
...
elseif level_id == "family" then -- Diamond Store
    triggers = {
        ...
        [100750] = { time = 120 + 80, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop } },
        [101568] = { time = 20, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop }, special_function = SF.SetTimeOrCreateTracker },
        [101566] = { time = 40, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop }, special_function = SF.SetTimeOrCreateTracker },
        [101572] = { time = 60, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop }, special_function = SF.SetTimeOrCreateTracker },
        [101573] = { time = 80, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop }, special_function = SF.AddTrackerIfDoesNotExist }
    }
...
elseif level_id == "friend" then -- Scarface Mansion
    triggers = {
        ...
        [100216] = { time = 662/30, random_time = 10, id = "EscapeBoat", icons = { Icon.Boat, Icon.Escape, Icon.LootDrop } },
...
elseif level_id == "rvd1" then -- Reservoir Dogs Heist Day 2
    triggers = {
        ...
        [100057] = { time = 60, id = "rvd_10", icons = { "C_Bain_H_ReservoirDogs_Pinky" }, class = TT.Achievement, condition = dw_and_above and show_achievement },
        [100169] = { time = 17 + 1 + 310/30, id = "PinkArrival", icons = { Icon.Car, "pd2_goto" } },
        ...
        [101114] = { time = 260/30, id = "PinkArrival", icons = { Icon.Car, "pd2_goto" }, special_function = SF.SetTimeOrCreateTracker },
        [101127] = { time = 201/30, id = "PinkArrival", icons = { Icon.Car, "pd2_goto" }, special_function = SF.SetTimeOrCreateTracker },
        [101108] = { time = 284/30, id = "PinkArrival", icons = { Icon.Car, "pd2_goto" }, special_function = SF.SetTimeOrCreateTracker }
    }
...
elseif level_id == "arm_for" then -- Transport: Train Heist
    ...
    triggers = {
        ...
        [105183] = { time = 30 + 524/30, id = "TruckSecureAmmo", icons = { "pd2_car", "pd2_lootdrop" } }
    }
...
elseif level_id == "bex" then -- San Martín Bank
    ...
    triggers = {
        ...
        [103919] = { time = 25 + 1 + 13, random_time = 5, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop } },
        [100840] = { time = 1 + 13, id = "Van", icons = { Icon.Car, Icon.Escape, Icon.LootDrop }, special_function = SF.SetTrackerAccurate },

        [101818] = { time = 50 + 9.3, random_time = 30, id = "HeliDropLance", icons = { "heli", "pd2_drill", "pd2_goto" }, class = "EHIInaccurateTracker" },
        [hack_start] = { id = "ServerHack", icons = { "wp_hack", "pd2_defend" }, class = "EHIPausableTracker", special_function = SF.UnpauseTrackerIfExistsAccurate, element = EHI:GetInstanceElementID(100014, 20450) },
...
elseif level_id == "pex" then -- Breakfast in Tijuana
    ...
    triggers = {
        [102355] = { max = 7, id = "pex_11", icons = { "C_Locke_H_BreakfastInTijuana_StolenValor" }, class = TT.AchievementProgress, condition = show_achievement },
...
elseif level_id == "fex" then -- Buluc's Mansion
    ...
    triggers = {
        ...
        -- Wanker car
        [EHI:GetInstanceElementID(100029, 27580)] = { time = 610/30 + 2, id = "CarEscape", icons = { "pd2_car", "pd2_escape", "pd2_lootdrop" }, special_function = SF.SetTimeOrCreateTracker },
