    ...
    if triggers[id] then
        if triggers[id].special_function then
            ...
            elseif f == SF.SetTimeNoAnimOrCreateTracker then
                if managers.hud:TrackerExists(triggers[id].id) then
                    managers.hud.ehi:CallFunction(triggers[id].id, "SetTimeNoAnim", triggers[id].time)
                else
                    CreateTracker(id)
                end
            ...
            elseif f == SF.IncreaseProgressMax then
                ...
                if managers.hud:TrackerExists(t_id) then
                    managers.hud.ehi:CallFunction(t_id, "IncreaseProgressMax")
                else
