local EHI = EHI
if EHI:CheckHookConditional("WalletGuiObject", _G.ch_settings ~= nil) or not EHI:GetOption("show_remaining_xp") or (EHI:IsPlayingCrimeSpree() and Global.load_level) then
    return
end
...
function WalletGuiObject.ehi_get_remaining_level()
