...
local triggers = {
    ...
    [100707] = { time = assault_delay_methlab, id = "FirstAssaultDelay", icons = Icon.FirstAssaultDelay, class = TT.Warning, special_function = SF.ALEX_1_SetTimeIfMoreThanOrCreateTracker },
