...
EHI:ShowAchievementLootCounter({ -- Medals
    ...
    load_sync = function(self)
        ...
        self._trackers:SetTrackerProgressRemaining("pex_11", self:CountUnitAvailable("units/pd2_dlc_pex/props/pex_props_federali_chief_medal/pex_props_federali_chief_medal", 1) - 5)
    end
})
local xp_override =
{
