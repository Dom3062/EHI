...
local triggers = {
    ...
    [1002151] = { id = 100008, special_function = SF.ShowWaypoint, data = { icon = Icon.Car, position_by_element = 100008 } },
    [100216] = { special_function = SF.Trigger, data = { 1, 1002161 } },
    [1002161] = { id = 100020, special_function = SF.ShowWaypoint, data = { icon = Icon.Car, position_by_element = 100020 } },
}
