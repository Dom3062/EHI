...
function EHIWaypointManager:AddWaypoint(id, params)
	...
	elseif type(params.icon) == "table" then
		icon, texture_rect = tweak_data.hud_icons:get_icon_data(params.icon[1] or "wp_standard", {
            0,
            0,
            32,
            32
        ...
        icon, texture_rect = tweak_data.hud_icons:get_icon_data(params.icon or "wp_standard", {
            0,
            0,
            32,
            32
...
function EHIWaypointManager:SetWaypointPause(id, pause)
	...
	self._waypoints[id].pause_timer = pause and 1 or 0
end
